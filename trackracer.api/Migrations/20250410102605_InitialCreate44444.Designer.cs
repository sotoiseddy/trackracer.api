...
namespace trackracer.api.Migrations
{
    ...
    [Migration("20250410102605_InitialCreate44444")]
    partial class InitialCreate44444
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("trackracer.Models.Accounts.ByNotUserModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<string>("NameofPersonwhoishim")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("SecurityPasscodefortheperson")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("ID");

                    b.ToTable("ByNotUserModel");
                });

            modelBuilder.Entity("trackracer.Models.Accounts.ByUserModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("SecurityPasscode")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.HasKey("ID");

                    b.ToTable("ByUserModel");
                });
